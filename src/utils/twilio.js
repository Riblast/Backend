...
import { twilioSID, twilioToken, twilioMessagingServiceSid, adminWhatsAppPhoneNumber, adminPhoneNumber } from '../config/config.js'
...
export const sendSMSCartToUser = async (newUser) => {
  ...
  try {
    const message = await client.messages.create({
      ...
      to: adminPhoneNumber // numero de Admin porque tiene que ser numero validado por twilio
    })
